-- CommuteConnect passenger journey search and geographic matching.
--
...
begin
  ...
  with matching_journeys as (
    ...
    where
      ...
      and j.seats_offered >= p_seats_needed
...
comment on function public.search_journeys(
  ...
  'Returns authenticated passenger-safe journey matches using 5 km endpoint proximity and a +/- 60 minute departure window. Exact stored coordinates and private journey details are not returned.';
